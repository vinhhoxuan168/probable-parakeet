...
public class DefaultIS32VoucherRedemptionDao {
    ...
    private static final String FIND_VOUCHERS_BY_CAMPAIGN = "select * from {Is32Promotion as p join order as o on {p.order} = {o.pk} join OrderStatus as os on {os.order} = {o.pk}} ";
